...
\centering
%暂时还没有画出流程图
%\includegraphics[width=3.5in]{your_flowchart_image_filename.png} % <-- 替换为您的流程图文件名
...
% 使用带星号的 table* 环境来实现跨双栏放置
% [t] 参数表示将表格放置在页面顶部 (top)
\begin{table*}[t]
    \caption{Performance comparison: (a) Docking scores (↓ better); (b) Diversity and drug-likeness metrics (↑ better except SA ↓ better).}
    \label{tab:performance_comparison_fullwidth} % 保持原label以避免引用失效
    \centering    
    % 使用 footnotesize 字体和紧密列间距以适配双栏布局
    \footnotesize
    \setlength{\tabcolsep}{3pt} % 紧密列间距
    ...
    \begin{minipage}{0.48\textwidth}
        ...
        \begin{tabular}{l c c c}
            ...
            Graph-GA & \textbf{-10.848$\pm$0.860} & -11.702$\pm$0.930 & -12.302$\pm$1.010 \\
            Autogrow 4.0 & \textbf{-11.371$\pm$0.398} & \textbf{-12.213$\pm$0.623} & \textbf{-12.474$\pm$0.839} \\
            RGA (ours) & \textbf{-11.867$\pm$0.170} & \textbf{-12.564$\pm$0.287} & \textbf{-12.869$\pm$0.473} \\
            \hline
            RGA - pretrain & -11.443$\pm$0.219 & -12.424$\pm$0.384 & -12.435$\pm$0.654 \\
            RGA - KT & -11.434$\pm$0.169 & -12.437$\pm$0.354 & -12.502$\pm$0.603 \\
            \hline 
            \textbf{FragGPT-GA} & & & \\
            \textbf{(Ours)} & & & \\
            \hline\hline
        \end{tabular}
        \vspace{0.5em}
        \textbf{(a) Docking scores}
    \end{minipage}
    \hfill % 水平填充分隔两个子表
    % 右侧子表：Diversity and drug-likeness metrics
    \begin{minipage}{0.48\textwidth}
        \centering
        \begin{tabular}{l c c c c}
            ...
            MARS & 100.0$\pm$0.0\% & \textbf{0.877$\pm$0.001} & \textbf{0.709$\pm$0.008} & \textbf{2.450$\pm$0.034} \\
            MolDQN & 100.0$\pm$0.0\% & 0.877$\pm$0.009 & 0.170$\pm$0.024 & 5.833$\pm$0.182 \\
            ...
            Gen3D & 100.0$\pm$0.0\% & \textbf{0.870$\pm$0.006} & 0.701$\pm$0.016 & 3.450$\pm$0.120 \\
            ...
            Autogrow 4.0 & 100.0$\pm$0.0\% & 0.852$\pm$0.011 & \textbf{0.748$\pm$0.022} & \textbf{2.497$\pm$0.049} \\
            RGA (ours) & 100.0$\pm$0.0\% & 0.857$\pm$0.020 & \textbf{0.742$\pm$0.036} & \textbf{2.473$\pm$0.048} \\
            \hline
            RGA - pretrain & 100.0$\pm$0.0\% & 0.854$\pm$0.035 & 0.750$\pm$0.034 & 2.494$\pm$0.043 \\
            RGA - KT & 100.0$\pm$0.0\% & 0.853$\pm$0.028 & 0.738$\pm$0.034 & 2.501$\pm$0.050 \\
            \hline 
            \textbf{FragGPT-GA} & & & & \\
            \textbf{(Ours)} & & & & \\
            \hline\hline
        \end{tabular}
        \vspace{0.5em}
        \textbf{(b) Diversity \& drug-likeness}
    \end{minipage}
\end{table*}
...
\begin{table*}[t]
    ...
    \begin{tabular}{l ccccc}
        ...
        \textit{f}-RAG (ours) & \textbf{-12.945 $\pm$ 0.053} & \textbf{-9.899 $\pm$ 0.205} & \textbf{-12.670 $\pm$ 0.144} & \textbf{-12.390 $\pm$ 0.046} & \textbf{-11.842 $\pm$ 0.316} \\
        \hline
        
        % --- 为您预留的两个空白行 ---
        \textbf{FragGPT-GA (Ours)} & & & & & \\
        \textbf{Model 2} & & & & & \\
        \hline
    \end{tabular}
\end{table*}
